...
OUT = os.path.expanduser('~/Library/Fonts/PaliHangulV285_Ga10.otf')
...
P = {
    'ga':   {'top_x':0.14, 'top_gap':8, 'bot_x':0.14, 'bot_gap':10, 'mac_x':0.40, 'mac_gap':8},
    'gan':  {'top_x':0.14, 'top_gap':6, 'bot_x':0.63, 'bot_gap':14, 'mac_x':0.40, 'mac_gap':7},
    'gang': {'top_x':0.14, 'top_gap':8, 'bot_x':0.86, 'bot_gap':10, 'mac_x':0.40, 'mac_gap':7},
    'kka':  {'top_x':0.16, 'top_gap':8, 'bot_x':0.16, 'bot_gap':10, 'mac_x':0.41, 'mac_gap':8},
    'kkan': {'top_x':0.16, 'top_gap':6, 'bot_x':0.66, 'bot_gap':14, 'mac_x':0.41, 'mac_gap':7},
    'kkang':{'top_x':0.16, 'top_gap':8, 'bot_x':0.86, 'bot_gap':10, 'mac_x':0.41, 'mac_gap':7},
    'kkin': {'top_x':0.16, 'top_gap':8, 'bot_x':0.70, 'bot_gap':14, 'mac_x':0.41, 'mac_gap':7},
}
...
if TRI_BELOW not in font:
    ...
    if 0x25BF in font:
        ...
        try:
            ...
            if 0x25BF in nf:
                nf.selection.select(0x25BF); nf.copy(); font.selection.select(0x25BF); font.paste()
                srcg = font[0x25BF]
            nf.close()
        except Exception:
            pass
...
font.fontname='PaliHangulV285Ga10'
font.familyname='PaliHangul V285 Ga10'
font.fullname='PaliHangul V285 Ga10'
font.version='2.85-ga10'
font.generate(OUT)
font.close()
print('Generated',OUT)
