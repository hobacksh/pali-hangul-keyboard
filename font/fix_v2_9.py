...
# 윗빈원/아래빈원 미세 조정 (글자 쪽으로 +10)
for uc, cy in [(0x030A, 760), (0x0325, -130)]:
...
font.fontname = 'PaliHangulV29'
font.familyname = 'PaliHangul V29'
font.fullname = 'PaliHangul V2.9'
font.version = '2.9'
...
font.generate(os.path.expanduser('~/Library/Fonts/PaliHangulV29.otf'))
font.close()
print('✅ v2.9 완료 (윗빈원 y=760, 아래빈원 y=-130)')
